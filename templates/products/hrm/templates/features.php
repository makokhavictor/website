        ...
        <div class="row">
            <div class="col-sm-6">
                <div class="lms-heading">
                    <h3>Features</h3>
                    <span>Stop all time-off abuses and centralize all your leave data.</span>
                </div>
            </div>
            <div class="col-sm-6">
...
<?php 
    ...
    <div class="row">
        <div class="col-sm-12">
            <h4 class="u-caps darh-heading bold">Main Human Resource Features</h4>
        </div>
        <div class="col-sm-4">
        ...
        <div class="container">
            <div class="row">
                <?php 
                    $results = select_data ( 'hr_features', array ( 'visibility' => 1 ), 'id, ASC' );
                    if ( empty ( $results ) ):
 ...
 <?php
    ...
    ob_end_clean();
    load_product_body('Hrm Features',$f_content);
?>