            ...
            <div class="container">
                <div class="col-sm-3">
                    <div class="navbar-header">
                        ...
                        <a class="navbar-brand" href="<?php echo DOMAIN; ?>">Global<span> HRM</span></a>
                    </div>
                </div>
                <div class="col-sm-6">
                    ...
                    <ul class="nav navbar-nav">
                        ...
                        <li <?php echo asign_current_state('about'); ?>><a href="<?php echo DOMAIN . 'hrm/about'; ?>">About</a></li>
                        <li <?php echo asign_current_state('features'); ?>><a href="<?php echo DOMAIN . 'hrm/features'; ?>">Features</a></li>           
